...
class _MemoryRepository implements MemoryRepository {
  ...
  @override
  Future<void> saveMemory({required body}) async {
  ...
  @override
  Future<void> deleteMemory({required id}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'accessToken': 'true'};
    _headers.removeWhere((k, v) => v == null);
...
String _$memoryRepositoryHash() => r'8dfa7c0f13cc3bdaf099356fedfff01977c94691';
...
typedef MemoryRepositoryRef = ProviderRef<MemoryRepository>;
